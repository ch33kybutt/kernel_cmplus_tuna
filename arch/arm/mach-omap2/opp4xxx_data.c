...
#define OMAP4460_VDD_MPU_OPPOVERCLOCK2_UV	1380000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
    ...
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOVERCLOCK_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
    VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOVERCLOCK2_UV, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0),
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1420000000, OMAP4460_VDD_MPU_OPPOVERCLOCK2_UV),
	/* L3 OPP1 - OPP50 */
